...
set_up_page_tables:
    ...
    ; ret
    mov ecx, 0 ; ecx is a counter variable
.map_p2_table:
    mov eax, 0x2000000 ; 2MiB
    mul ecx ; 2MiB * idx
    or eax, 0b10000011 ; present + writable  + huge
    mov [p2_table + ecx * 8], eax ; map eax to idx th entry
    inc ecx
    cmp ecx, 512
    jne .map_p2_table ; do it tail recursively 512 time

    ret

; enable paging
; enable paging and entering to long mode.
enable_paging:
